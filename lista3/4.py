...
BASE_DIR = Path(r"D:\projetos\vscp\Visao-Computacional\lista3")
OUT_DIR = BASE_DIR / "panoramas_resultados"
...
def gerar_panoramas(nome_trio, arquivos):
    ...
    for plano in [1, 2, 3]:
        ...
        # Utiliza as proporÃ§Ãµes exclusivas da imagem que estÃ¡ sendo usada como base
        img_base = imagens[plano - 1]
        altura, largura = img_base.shape[:2]
        translacao = np.eye(3, dtype=np.float64) # MantÃ©m a matriz de translaÃ§Ã£o neutra
